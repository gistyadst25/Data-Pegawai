...
class PegawaiController extends Controller
{
    ...
    {
    $model = new Pegawai;
    $riwayat_pendidikan = RiwayatPendidikan::all(); 

    return view('pegawai.create', compact('model', 'riwayat_pendidikan'));
    }
    ...
    public function store_riwayat(Request $request, $id)
    {
        ...
        return redirect('pegawai/'.$id.'/edit')->with('success', "Data Berhasil Diperbarui!");
    }
