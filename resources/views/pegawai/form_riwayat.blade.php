        ...
        @foreach($riwayat_pendidikan as $riwayat)
            <tr>
                ...
                <td class="text-center">
                    ...
                    data-periode_pendidikan="{{ $riwayat->periode_pendidikan }}">
                ...
                <td class="text-center">
                    <form action="{{ url('pegawai/'.$riwayat->id.'/'.$model->id.'/riwayat') }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger btn-delete" type="submit" ></button>
                        <span data-feather="trash-2" style="font-size: 20px;"></span>Delete</button>
                    </form>
                </td>
            </tr>
        @endforeach
